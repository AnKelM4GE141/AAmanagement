      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-medium text-gray-900">New Contract</h2>
          ...
          {selectedOpp && (
            <div className="bg-gray-50 rounded-md p-3 space-y-1">
              <p className="text-sm">
                ...
                <span className="text-gray-900">{selectedOpp.contact_name}</span>
              </p>
              <p className="text-sm">
                <span className="font-medium text-gray-700">Email:</span>{' '}
                <span className="text-gray-600">{selectedOpp.contact_email}</span>
              </p>
              {selectedOpp.property_address && (
                <p className="text-sm">
                  <span className="font-medium text-gray-700">Property:</span>{' '}
                  <span className="text-gray-600">{selectedOpp.property_address}</span>
                </p>
              )}
            </div>
          )}
